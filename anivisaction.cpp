...
wls_anivis_watcher *DzAniVisAction::anivis_watcher_ = nullptr; //new wlsAnivisWatcher();

DzAniVisAction::DzAniVisAction() :
	DzEditAction( "Add AniVis Property", "Add the Animate Visibility to the selected Node(s)" )
{
	// create the watcher
	anivis_watcher_ = new wls_anivis_watcher();
	anivis_watcher_->hook_scene();
}
